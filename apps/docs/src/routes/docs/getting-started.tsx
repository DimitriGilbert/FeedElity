      ...
      <main className="max-w-3xl">
        ...
        <section className="mt-10">
          ...
          <p className="mt-4 leading-relaxed text-neutral-400">
            ...
            high-density interface. It is self-hosted and privacy-focused.
          </p>
          <p className="mt-4 leading-relaxed text-neutral-400">
        ...
        <section className="mt-12">
          ...
          <div className="mt-6 space-y-6">
            ...
            <div>
              ...
              <pre className="mt-2 overflow-x-auto rounded-lg border border-neutral-800 bg-neutral-900 px-4 py-3 font-mono text-sm text-neutral-300">
                <code>cp docker/.env.example .env</code>
              </pre>
              <p className="mt-2 text-sm text-neutral-500">
                Open <code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">.env</code> and set
                the three variables Compose reads:{" "}
                <code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">FEEDELITY_PUBLIC_URL</code> (the
                URL browsers use to reach the app),{" "}
                <code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">FEEDELITY_CORS_ORIGIN</code> (allowed
                origins for the API), and{" "}
                <code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">FEEDELITY_AUTH_SECRET</code>, a
                random string of at least 32 characters (for example{" "}
                <code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">openssl rand -base64 48</code>).
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-neutral-500">
                There are no pre-built images: both containers are built from
                source. On first start the server seeds its database from your
                local dev snapshot (<code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">./local.db</code>) if
                present, otherwise it starts with an empty database.
              </p>
            </div>
            ...
            <div>
              ...
              <pre className="mt-2 overflow-x-auto rounded-lg border border-neutral-800 bg-neutral-900 px-4 py-3 font-mono text-sm text-neutral-300">
                <code>http://localhost:31000</code>
              </pre>
              <p className="mt-2 text-sm text-neutral-500">
                The web app is published on port 31000 and the API server on
                port 31001. Create an account and start adding sources.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-neutral-500">
                This starts a local libSQL server on port 8080, backed by the{" "}
                <code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">local.db</code> file at
                the repo root. The server's default dev database points at this
                file (<code className="rounded bg-neutral-800 px-1.5 py-0.5 text-neutral-300">file:../../local.db</code> in{" "}
